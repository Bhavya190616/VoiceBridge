...
class SignToSpeechEngine:
    def __init__(self, frame_q, status_cb, emotion_cb=None):
        ...
        self._hold_needed={"neutral":10,"happy":5,"sad":14,"angry":10,"surprise":8,"fear":10,"disgust":10}
    ...
    def _speak(self, text, emotion):
        ...
        def run():
            ...
            elif emotion=="surprise": rate,vol,p=175,1.0,f"— {words}?"
            elif emotion=="fear":     rate,vol,p=178,0.75,f"{words}... please."
            elif emotion=="disgust":  rate,vol,p=128,0.82,f"{words}."
    ...
    def _run(self):
        ...
        while not self._stop.is_set():
            ...
            if face_result.face_blendshapes:
                ...
                surprise_score=eye_jaw+brow_R_genuine*eye_jaw*8.0-brow_down*5.0
                ...
                fear_score=max(0,eye_wide-0.08)*3.0+lip_stretch*1.0-brow_down*2.0-smile*2.0
                ...
                scores={"happy":happy_score,"sad":sad_score,"angry":angry_score,
                        "surprise":surprise_score,"disgust":disgust_score,"fear":fear_score,"neutral":0.16}
            ...
            emo_colors={"neutral":(140,140,150),"happy":(0,220,100),"sad":(100,140,220),
                        "angry":(60,60,220),"surprise":(0,200,230),"fear":(180,80,220),"disgust":(80,180,80)}
...
class SpeechToSignEngine:
    ...
    def _run(self):
        ...
        try:
            dev_info=sd.query_devices(DEVICE_INDEX,'input'); samplerate=int(dev_info['default_samplerate'])
        ...
        try:
            with sd.RawInputStream(samplerate=samplerate,blocksize=8000,dtype='int16',
                                   channels=1,callback=lambda i,f,t,s:audio_q.put(bytes(i)),device=DEVICE_INDEX):
                while not self._stop.is_set():
...
class VoiceBridgeApp(ctk.CTk):
    ...
    def _make_placeholder(self, msg, color_hex):
        ...
        try:    font_hint = ImageFont.truetype("arial.ttf", 13)
